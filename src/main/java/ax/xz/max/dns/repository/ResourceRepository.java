...
public interface ResourceRepository {
	...
	<T extends ResourceRecord> List<T> getAllByNameAndType(DomainName name, Class<T> clazz) throws ResourceAccessException;
	<T extends ResourceRecord> List<T> deleteAllByNameAndType(DomainName name, Class<T> clazz) throws ResourceAccessException;

	<T extends ResourceRecord> List<T> getAllByType(Class<T> clazz) throws ResourceAccessException;
	<T extends ResourceRecord> List<T> deleteAllByType(Class<T> clazz) throws ResourceAccessException;
}
